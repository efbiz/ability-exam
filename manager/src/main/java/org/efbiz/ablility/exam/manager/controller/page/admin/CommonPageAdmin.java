...
public class CommonPageAdmin {
  ...
  public String tagListPage(Model model,
    ...
    String pageStr = PagingUtil
        .getPagelink(index, page.getTotalPage(), "", "admin/common/tag-list");
  ...
  public String fieldListPage(Model model,
      @RequestParam(value = "page", required = false, defaultValue = "1") int index) {
    ...
    String pageStr = PagingUtil
        .getPagelink(index, page.getTotalPage(), "", "admin/common/field-list");
  ...
  public String knowledgeListPage(Model model, @PathVariable("fieldId") int fieldId,
      @RequestParam(value = "page", required = false, defaultValue = "1") int index) {
    ...
    String pageStr = PagingUtil
        .getPagelink(index, page.getTotalPage(), "", "admin/common/knowledge-list/" + fieldId);
  ...
  public String depListPage(Model model,
      @RequestParam(value = "page", required = false, defaultValue = "1") int index) {
    ...
    String pageStr = PagingUtil
        .getPagelink(index, page.getTotalPage(), "", "admin/common/dep-list");
