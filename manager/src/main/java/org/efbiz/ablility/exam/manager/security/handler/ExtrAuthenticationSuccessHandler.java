package org.efbiz.ablility.exam.manager.security.handler;
...
/**
 * <tt>AuthenticationSuccessHandler</tt> which can be configured with a default URL which users
 * should be
 * sent to upon successful authentication.
 * <p>
 * The logic used is that of the {@link AbstractAuthenticationTargetUrlRequestHandler parent
 * class}.
 *
 * @author Joni
 * @since 3.0
 */
public class ExtrAuthenticationSuccessHandler extends
   ...
   *
   * @param defaultTargetUrl the URL to which the user should be redirected on successful
   * authentication.
   */
