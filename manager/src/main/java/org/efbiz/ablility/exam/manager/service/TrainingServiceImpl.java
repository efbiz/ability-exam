...
import org.efbiz.ablility.exam.manager.persistence.TrainingMapper;
...
public class TrainingServiceImpl implements TrainingService {
  ...
  @Override
  public List<TrainingSection> getTrainingSectionById(int sectionId, int userId,
      Page<TrainingSection> page) {
    // TODO Auto-generated method stub
  ...
  public Map<Integer, List<TrainingSectionProcess>> getTrainingSectionProcessMapByTrainingId(
    ...
    List<TrainingSectionProcess> processList = trainingMapper
        .getTrainingSectionProcessListByTrainingId(trainingId, idList, searchStr, null);
