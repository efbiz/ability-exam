...
import org.efbiz.ability.exam.common.domain.question.PointStatistic;
import org.efbiz.ability.exam.common.domain.question.Question;
import org.efbiz.ability.exam.common.domain.question.QuestionContent;
import org.efbiz.ability.exam.common.domain.question.QuestionFilter;
...
import org.efbiz.ability.exam.common.domain.question.QuestionStruts;
import org.efbiz.ability.exam.common.domain.question.QuestionTag;
import org.efbiz.ability.exam.common.domain.question.QuestionType;
import org.efbiz.ability.exam.common.domain.question.Tag;
import org.efbiz.ability.exam.common.util.Page;
import org.efbiz.ability.exam.common.util.file.ExcelUtil;
import org.efbiz.ablility.exam.manager.persistence.QuestionMapper;
...
public class QuestionServiceImpl implements QuestionService {
  ...
  @Override
  public List<QuestionTag> getQuestionTagByQuestionIdAndUserId(int questionId, int userId,
      Page<QuestionTag> page) {
    // TODO Auto-generated method stub
  ...
  public void updateQuestionPoint(Question question, int userId,
    ...
    try {
      ...
      if (questionTagList != null && questionTagList.size() != 0) {
        questionMapper
            .deleteQuestionTag(question.getId(), userId, idList.size() == 0 ? null : idList);
        questionMapper.addQuestionTag(questionTagList);
      } else {
        questionMapper
            .deleteQuestionTag(question.getId(), userId, idList.size() == 0 ? null : idList);
  ...
  public void uploadQuestions(String filePath, String username, int fieldId) {
    ...
    filePath = System.getProperty("catalina.base") + strPath.replace(',', File.separatorChar)
        + File.separatorChar
        + filePath;
    ...
    try {
      ...
      for (Map<String, String> map : questionMapList) {
        ...
        question.setName(
            map.get("题目").length() > 10 ? map.get("题目").substring(0, 10) + "..." : map.get("题目"));
  ...
  @Override
  public Map<String, KnowledgePoint> getKnowledgePointMapByFieldId(int fieldId,
  ...
  public Question getQuestionDetail(int questionId, int userId) {
    ...
    try {
      ...
      List<QuestionTag> tagList = questionMapper
