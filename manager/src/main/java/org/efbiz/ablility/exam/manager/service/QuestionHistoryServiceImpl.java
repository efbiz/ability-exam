...
import org.efbiz.ablility.exam.manager.persistence.QuestionHistoryMapper;
...
public class QuestionHistoryServiceImpl implements QuestionHistoryService {
  ...
  public Map<Integer, QuestionStatistic> getQuestionHistStaticByFieldId(int fieldId, int userId) {
    // TODO Auto-generated method stub
    List<QuestionStatistic> statisticList = questionHistoryMapper
        .getQuestionHistStaticByFieldId(fieldId, userId);
