...
public interface ExamMapper {
   ...
   * @return
   */
  public List<ExamHistory> getUserExamHistListByExamId(@Param("examId") int examId,
      @Param("searchStr") String searchStr, @Param("order") String order, @Param("limit") int limit,
      @Param("page") Page<ExamHistory> page);
   ...
   * @param mark
   */
  public void changeUserExamHistStatus(@Param("histId") int histId,
   ...
   */
  public void updateUserExamHist(@Param("answerSheet") AnswerSheet answerSheet,
      @Param("answerSheetStr") String answerSheetStr, @Param("approved") int approved);
   ...
   * @return
   */
  public ExamHistory getUserExamHistByUserIdAndExamId(@Param("userId") int userId,
      @Param("examId") int examId, @Param("array") int[] approvedType);
