package org.efbiz.ablility.exam.manager.controller.page;
...
import org.efbiz.ablility.exam.manager.service.SystemService;
...
public class BasePage {
  ...
  public String directToBaseHomePage(Model model, HttpServletRequest request) {
    ...
    if (grantedAuthorities.contains(new GrantedAuthorityImpl("ROLE_ADMIN"))) {
      LinkedHashMap<String, MenuItem> map = (LinkedHashMap<String, MenuItem>) systemService
          .getMenuItemsByAuthority("ROLE_ADMIN");
      userInfo.setMenuMap(map);
      return "redirect:admin/home";
    } else if (grantedAuthorities.contains(new GrantedAuthorityImpl("ROLE_TEACHER"))) {
      LinkedHashMap<String, MenuItem> map = (LinkedHashMap<String, MenuItem>) systemService
          .getMenuItemsByAuthority("ROLE_TEACHER");
      userInfo.setMenuMap(map);
