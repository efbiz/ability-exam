...
import org.efbiz.ability.exam.portal.persistence.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
  ...
  @Override
  public List<Comment> getCommentByTypeAndReferId(int commentType, int referId, int indexId,
      Page<Comment> page) {
  ...
  public void addComment(Comment comment) {
    // TODO Auto-generated method stub
    try {
      Object index = commentMapper
          .getMaxCommentIndexByTypeAndReferId(comment.getCommentType(), comment.getReferId());
      int i = 0;
      if (index == null) {
        i = 0;
      } else {
