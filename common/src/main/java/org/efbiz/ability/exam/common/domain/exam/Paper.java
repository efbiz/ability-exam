package org.efbiz.ability.exam.common.domain.exam;
...
import org.efbiz.ability.exam.common.util.Roulette;


/**
 * 个体（试卷） 每次生成一个新试题序列，计算一次适应度 适应度越高，就越能遗传到下一代 这里适应度通过曝光率和难度系数计算 <br> a.难度系数和给定难度系数差的绝对值（D）最小
 * b.曝光度（E）最小 适应度F=1/D+E 1/D+E 越小，适应度越好
 *
 * <br>
 * 给定试卷难度系数和生成试卷难度系数差的绝对值越小越好 <br> 曝光度越大越好 <br> 涵盖的知识点越多越好
 *
 * @author mars
 */
public class Paper {
