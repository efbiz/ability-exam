...
public interface TrainingMapper {
  ...
  public List<TrainingSection> getTrainingSectionByTrainingId(@Param("trainingId") int trainingId,
      @Param("page") Page<TrainingSection> page);
   ...
   * @return
   */
  public UserTrainingHistory getTrainingHistBySectionId(@Param("sectionId") int sectionId,
   ...
   * @return
   */
  public List<TrainingSectionProcess> getTrainingSectionProcessListByUserId(
      @Param("userId") int userId, @Param("page") Page<TrainingSectionProcess> page);
}
