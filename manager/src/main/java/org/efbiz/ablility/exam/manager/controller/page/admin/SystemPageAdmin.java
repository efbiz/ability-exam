...
import org.efbiz.ablility.exam.manager.service.NewsService;
...
public class SystemPageAdmin {
  ...
  private String adminListPage(Model model, HttpServletRequest request) {
    ...
    List<User> userList = userService
        .getUserListByRoleId(userInfo.getRoleMap().get("ROLE_ADMIN").getRoleId(), page);
    String pageStr = PagingUtil
        .getPagelink(index, page.getTotalPage(), "", "admin/system/admin-list");
  ...
  private String newsListPage(Model model, HttpServletRequest request,
    ...
    String pageStr = PagingUtil
        .getPagelink(page, pageModel.getTotalPage(), "", "admin/system/news-list");
