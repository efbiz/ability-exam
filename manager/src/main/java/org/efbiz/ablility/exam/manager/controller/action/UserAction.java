...
public class UserAction {
  ...
  public @ResponseBody
  Message resetUserPwd(Model model, @PathVariable("password") String password,
  ...
  public @ResponseBody
  Message changeUserStatus(Model model, @PathVariable("userId") int userId,
  ...
  public @ResponseBody
  Message modifyGroup(@PathVariable("groupId") int groupId,
  ...
  public @ResponseBody
  Message addUserGroupWithUserNameList(@RequestBody String userNames,
  ...
  public @ResponseBody
  Message addUserGroupWithUserNameList(@PathVariable("userId") int userId,
      @PathVariable("groupId") int groupId) {
    Message msg = new Message();
    UserInfo userInfo = (UserInfo) SecurityContextHolder.getContext().getAuthentication()
        .getPrincipal();
