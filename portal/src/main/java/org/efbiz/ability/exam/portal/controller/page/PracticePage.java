...
public class PracticePage {
  ...
  public @ResponseBody
  List<Integer> getFinishedQuestionId(Model model, HttpServletRequest request,
      @PathVariable("fieldId") int fieldId,
      @PathVariable("knowledgePointId") int knowledgePointId,
      @PathVariable("questionTypeId") int questionTypeId) {
  ...
  public String practiceStartNew(Model model, HttpServletRequest request,
    ...
    Map<Integer, Map<Integer, List<QuestionQueryResult>>> map = questionService
        .getQuestionMapByFieldId(fieldId, null);
    List<QuestionQueryResult> qqrList = new ArrayList<QuestionQueryResult>();
  ...
  public String practiceListPage(Model model, HttpServletRequest request,
    ...
    Map<Integer, KnowledgePoint> pointMap = questionService
        .getKnowledgePointByFieldId(null, fieldId);
