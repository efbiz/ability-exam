...
public class MyInterceptor implements Interceptor {
  ...
  public synchronized void setTotalRecord(BoundSql boundSql, MappedStatement mappedStatement,
    ...
    ParameterHandler parameterHandler = new DefaultParameterHandler(mappedStatement, mapperParamMap,
        countBoundSql);
