...
import org.efbiz.ability.exam.portal.service.NewsService;
...
public class UserPage {
  ...
  public String loginPage(Model model,
    ...
    AuthenticationServiceException exception = (AuthenticationServiceException) request.getSession()
        .getAttribute("SPRING_SECURITY_LAST_EXCEPTION");
    if (exception != null) {
      if ("准考证号码错误！".equals(exception.getMessage()) || "不在考试时间范围内，不允许使用准考证！"
  ...
  public String quickStartPage(Model model,
      @RequestParam(value = "result", required = false, defaultValue = "") String result) {
