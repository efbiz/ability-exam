...
public interface UserMapper {
   ...
   * @return
   */
  public List<User> getUserListByRoleId(@Param("roleId") int roleId,
   ...
   * @param enabled
   */
  public void changeUserStatus(@Param("array") List<Integer> idList,
   ...
   * @return
   */
  public List<User> getUserListByGroupIdAndParams(@Param("groupId") int groupId,
   ...
   * @return
   */
  public List<User> getUserListByGroupIdList(@Param("array") List<Integer> idList,
